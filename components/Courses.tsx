...
export const Courses = () => {
    return (
        <section className='pb-6' id='courses'>
            ...
            <div className='grid gap-6'>
                ...
                <div className='grid gap-2'>
                    <h3 className='text-xl'>JavaScript (Advanced Course)</h3>
                    <Link
                        target='_blank'
                ...
                <div className='grid gap-2'>
                    <h3 className='text-xl'>The Complete 2021 Web Development Bootcamp</h3>
                    <Link
                        target='_blank'
                ...
                <div className='grid gap-2'>
                    <h3 className='text-xl'>Web Development Course</h3>
                    <Link
                        target='_blank'
